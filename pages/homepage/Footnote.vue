...
const spanText = 'text-xs text-footer-text'
const liWrapper = 'pb-[10px] leading-4'
const linkWrapper = 'underline text-footer-link'
</script>
<template>
  <ul>
    <li :class="liWrapper">
    ...
    <li :class="liWrapper">
      <span :class="spanText">
        ...
        <a href="/" :class="linkWrapper">apple.com</a> and at Apple retail
        stores in the U.S.
      </span>
    </li>
    <li :class="liWrapper">
    ...
    <li :class="liWrapper">
      <span :class="spanText">
        ...
        877-255-5923 with questions about Apple Card.</span
      >
    </li>
    <li :class="liWrapper">
      <span :class="spanText">
        Learn more about how Apple Card applications are evaluated at
        <a href="/" :class="linkWrapper">support.apple.com/kb/HT209218 </a>.
      </span>
    </li>
    <li :class="liWrapper">
      <span :class="spanText">A subscription is required for Apple TV+.</span>
    </li>
  </ul>
</template>
